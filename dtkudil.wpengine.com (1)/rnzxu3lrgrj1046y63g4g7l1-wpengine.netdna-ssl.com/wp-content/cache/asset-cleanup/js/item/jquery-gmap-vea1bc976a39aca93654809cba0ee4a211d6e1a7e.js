/*!/wp-content/plugins/designthemes-core-features/shortcodes/js/jquery.gmap.js*/ ! function(a) {
    "use strict";
    var b = function() {
    ...
    g = {
        ...
        addMarker: function(a) {
            ...
            a.icon && void 0 == a.icon.iconsize && (h = new c.MarkerImage(d.image));
        ...
        changeSettings: function(a) {
            var b = this.data("gmap");
            void 0 === a.markers ? a.markers = g._convertMarkers(b.markers) : 0 !== a.markers.length && void 0 === a.markers[0].latitude && (a.markers = g._convertMarkers(a.markers)), a.zoom && g.setZoom.apply(this, [a.zoom, a]), (a.latitude || a.longitude) && b.gmap.panTo(g._getMapCenter.apply(this, [a]))
        },
        mapclick: function(a) {
